...
date: "2026-03-19"
excerpt: "A Chrome extension that captures page context and shares it with AI agents via REST or MCP. The interesting part wasn't the extension — it was building an MCP server into the same Cloudflare Worker."
