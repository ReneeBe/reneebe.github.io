...
The heading also picks up the word "walkshed". I learned it from the GIS literature. It's the everyday name for a walking isochrone, the same way "watershed" is the area that drains to a single point. "Bikeshed" is the obvious extension. Same idea, two modes.
