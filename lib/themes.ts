...
const AMBER_SCANLINES =
  "repeating-linear-gradient(0deg, rgba(255,176,0,0.07) 0px, rgba(255,176,0,0.07) 1px, transparent 1px, transparent 3px)";
...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    vars: {
      ...
      "--glass-strong-bg": "rgba(0, 255, 65, 0.07)",
      "--glass-strong-border": "rgba(0, 255, 65, 0.18)",
      "--blur-glass": "12px",
      "--blur-glass-strong": "20px",
      "--font-heading": MONO,
      "--font-body": MONO,
      "--bg-pattern": MATRIX_SCANLINES,
    },
  },
  {
    id: "sunset",
  ...
  },
  {
    ...
    vars: {
      ...
      "--grad-c": "#ffd700",
      "--grad-d": "#ff6600",
      "--glass-bg": "rgba(255, 176, 0, 0.05)",
      "--glass-border": "rgba(255, 176, 0, 0.15)",
      "--glass-strong-bg": "rgba(255, 176, 0, 0.08)",
      "--glass-strong-border": "rgba(255, 176, 0, 0.22)",
      "--blur-glass": "12px",
      "--blur-glass-strong": "20px",
      "--font-heading": MONO,
      "--font-body": MONO,
  ...
  },
  {
    ...
    vars: {
      ...
      "--grad-d": "#c5a028",
      "--glass-bg": "rgba(255, 255, 255, 0.04)",
      "--glass-border": "rgba(200, 230, 180, 0.10)",
      "--glass-strong-bg": "rgba(255, 255, 255, 0.07)",
      "--glass-strong-border": "rgba(200, 230, 180, 0.16)",
      "--blur-glass": "24px",
      "--blur-glass-strong": "40px",
      "--font-heading": LORA,
      "--font-body": LORA,
